...
class SpotExpenseEditModal extends React.Component {
  state={
    categoryList:[],
    cashAccnts:[],
    expenseAccnts:[],
  ...
  componentWillMount(){
    this.setState({
      ...
      selectedCategory:this.props.categoryList.filter(item=>item.id === this.props.formData.ExpenseCategory)[0].name,
      selectedExpnseAcccnt:this.props.expenseAccnts.filter(item=>item.id === this.props.formData.ExpenseAcct)[0].name,
      selectedCashAccnt:this.props.cashAccnts.filter(item => item.id === this.props.formData.CreditAcct)[0].name,
  ...
  submitDataHandler=(e)=>{
    ...
    this.props.formData.ExpenseCategory = expenseCategoryObj[0].id
    this.props.formData.ExpenseAcct = expenseAccntObj[0].id
    this.props.formData.CreditAcct = cashAccntObj[0].id
...
export default SpotExpenseEditModal;
