...
import ExpenseCategoryList from './ExpenseCategoryList/ExpenseCategoryList';
import {Button, Table, Modal} from 'react-bootstrap';

import * as actions from '../../../store/actions/index';

class ExpenseCategoryListPage extends Component {
  componentDidMount(){
...
export default connect(mapStateToProps,mapDispatchToProps)(ExpenseCategoryListPage);
